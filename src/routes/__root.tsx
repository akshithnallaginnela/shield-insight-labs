    ...
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="glass-card max-w-md rounded-2xl p-8 text-center">
        ...
        <button
          ...
          className="mt-5 rounded-lg bg-gradient-to-r from-cyber to-neon px-4 py-2 text-sm font-semibold text-background"
        >Try again</button>
      </div>
    </div>
  );
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered scam detection for phishing, fake recruiters, WhatsApp fraud, and manipulative messages." },
